...
export default function TutorialHelpButton({ compact = false }: { compact?: boolean }) {
  ...
  return (
    <button
      ...
      className="inline-flex items-center justify-center gap-2 rounded-lg border border-border bg-card px-3 py-2 text-sm font-semibold text-text shadow-sm transition hover:bg-surface-2 focus:outline-none focus:ring-2 focus:ring-accent"
